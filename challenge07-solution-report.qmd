...
tar_load(action_types, store = "challenge07")
tar_load(data_users_only, store = "challenge07")
tar_load(actions_per_visit, store = "challenge07")
tar_load(time_minmax, store = "challenge07")
tar_load(time_since_last_visit,store = "challenge07")
tar_load(numeric_id, store = "challenge07")
tar_load(time_spent, store = "challenge07")
tar_load(time_duration, store = "challenge07")
