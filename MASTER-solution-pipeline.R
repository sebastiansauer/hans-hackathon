...
# longify data ------------------------------------------------------------
  ...
  # Challenge 06/07: Count stuff per visit ------------------------------------------
...
# Challenge 10: Nutzerverhalten im Zeitverlauf ----------------------------
...
# Render report -----------------------------------------------------------
  ...
  # tar_quarto(challenge08_report, path = "challenges_solutions/challenge08-solution-report.qmd")
