...
```
1. Wie kann man eine Spalte an den Anfang eines Dataframes ziehen?
...
```
1. Erläutern Sie, was mit "Pivotieren" gemeint ist im Kontext des vorliegenden Projekts der Datenanalyse. Was ist der Nutzen des Pivotierens?
