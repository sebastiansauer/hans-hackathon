...
```{r}
datafiles_list <- list.files(path = paste0(here(),"/",
                                           "data-processed/data-raw-no-sensitive"),
                             pattern = "csv$",
                             full.names = TRUE)
```
...
Aucht nicht... Wir könnten alle relevanten Spalten suchen und mit `col_character` umwandeln.
